...
@section('content')
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="" src="{{ asset('storage/' . $product->main_image_path) }}"
                                style="object-fit: cover; width: 542px; height: 542px;" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">{{ number_format($product->sale_price, 0, ' ', ' ') }} FCFA</h3>
                    ...
                    <div>
                        <span>Contacter nous pour commander : </span>
                        <b style="text-decoration: underline;">00228 90 87 95 89</b>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media mb-4">
                                        <img src="{{ asset('front-assets/img/user.jpg') }}" alt="Image"
    ...
    <div class="container-fluid py-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Vous
                aimerez aussi</span></h2>
        <div class="row px-xl-5">
            <div class="col">
                    ...
                    @foreach ($otherProducts as $product)
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('storage/' . $product->main_image_path) }}"
